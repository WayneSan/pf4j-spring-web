 ...
 */
package com.example.spring.web.plugin.json;

import java.lang.reflect.Type;
import java.util.List;

import com.example.spring.web.api.ExporterBase;
import com.example.spring.web.api.model.Person;
...
public class JSonExporter extends ExporterBase {
    ...
    /** (non-Javadoc)
     * @see org.pf4j.demo.api.ExporterBase#export(List)
     */
